...
const handleSelect = (id) => {
  ...
  if ((selectedAction === "create" || selectedAction === "update") && !data.speciesName) {
    alert("Validation Error: Please choose a valid Species from the dropdown list before submitting.");
   ...
   if (selectedAction === "create") {
      ...
      const updatedAnimalItem = {
        ...
        age: data.age !== null && data.age !== "" ? Number(data.age) : selectedAnimalItem.age,
        weight: data.weight !== null && data.weight !== "" ? Number(data.weight) : selectedAnimalItem.weight,
      ...
      setAnimalItems(
        animalItems.map((item) => 
          item.id.toString() === selectedAnimalItem.id.toString() ? updatedAnimalItem : item));
    }
    else if (selectedAction === "delete" && selectedAnimalItem) {
      // Clean array filtering with no reference errors
      setAnimalItems(
        animalItems.filter((item) => item.id.toString() !== selectedAnimalItem.id.toString())
      );
    }
  ...
  return (
    <div className="module-management-container">
      ...
      {(selectedAction === "read" || selectedAction === "update" || selectedAction === "delete") && !selectedAnimalItem && (
      ...
      {(selectedAction === "create" || 
        ((selectedAction === "update" || selectedAction === "delete") && selectedAnimalItem)) && (
